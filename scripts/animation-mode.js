...
const colorArrayList = [
  ...
  ["#7FFF00", "#D7FF00", "#00FF04", "#00FFB3", "#00FFB3"], // 4 index
  ["#B20D30", "#F0E2E7", "#3F84E5", "#C17817", "#3F784C"], // 5 index
  ["#ffffff", "#EDEDED", "#DBDBDB", "#C8C8C8", "#B6B6B6"], // 6 index
  ["#FF9900", "#1C1C1C"], // 7 index
];
...
document.getElementById("circleStroke").addEventListener("click", function () {
  // circle stroke button
  isFill = false;
  isAbstract = true;
  isFinished = false;
  initStroke();
...
document.getElementById("abstractMode").addEventListener("click", function () {
  // abstract button
  isAbstract = false;
  init();
});
